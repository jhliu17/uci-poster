% Unofficial University of California, Irvine Poster Template
% https://github.com/jhliu17/uci-poster
...
\author{Alyssa P. Hacker \inst{1} \and Alyssa P. Hacker \inst{2} \and Lem E. Tweakit \inst{2}}
...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {\includegraphics[height=3.5cm]{logos/university-of-california-irvine-uci-vector-logo-white.eps}};
